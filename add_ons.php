  ...
  <div id="main">
    ...
    <div class="wrapper">
              ...
              <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-editor-insert-invitation"></i> Edit Items</a>
                <div class="collapsible-body">
                  <ul>
                    ...
                    <li class = "active"><a href="add_ons.php">Add Ons</a></li>
                  </ul>
                </div>
              </li>
            </ul>
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Add Ons List</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">Add, Edit or Remove Add Ons.</p>
            ...
            <div class="row">
              ...
              <div>
				<table id="data-table-admin" class="responsive-table display" cellspacing="0">
                    ...
                    <tbody>
				<?php
				$result = mysqli_query($con, "SELECT * FROM items WHERE category = 'add_ons'");
		  ...
		  <form class="formValidate" id="formValidate1" method="post" action="routers/add-addons.php" novalidate="novalidate">
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">New Add Ons Item</h4>
              </div>
              <div>
<table>
                    <thead>

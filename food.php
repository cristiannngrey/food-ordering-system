  ...
  <div id="main">
    ...
    <div class="wrapper">
      ...
      <section id="content">
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">Add, Edit or Remove Food Menu Items.</p>
            ...
            <div class="row">
              ...
              <div>
				<table id="data-table-admin" class="responsive-table display" cellspacing="0">
                    ...
                    <tbody>
				<?php
				$result = mysqli_query($con, "SELECT * FROM items WHERE category = 'food'");
		  ...
		  <form class="formValidate" id="formValidate1" method="post" action="routers/add-food.php" novalidate="novalidate">
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Add Food Item</h4>
              </div>
              <div>
<table>
                    <thead>

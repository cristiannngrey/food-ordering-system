  ...
  <div id="main">
    ...
    <div class="wrapper">
          ...
          <li class="no-padding">
            <ul class="collapsible collapsible-accordion">
              <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-question-answer"></i> Reports</a>
                <div class="collapsible-body">
                  <ul>
								    <li><a href="reports.php">Daily Sales</a></li>
                    <li><a href="reports.php">Weekly Sales</a></li>
                  </ul>
                </div>
              </li>
            </ul>
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Add Item</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">Add new item to the menu.</p>
                ...
                <div>
                  <table>
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <div class="input-field col s12"><label for="name">Name</label>
                            <input id="name" name="name" type="text" data-error=".errorTxt01"><div class="errorTxt01">
                          </div>
                        </td>					
                        <td>
                          <div class="input-field col s12 "><label for="price" class="">Price</label>
                            <input id="price" name="price" type="text" data-error=".errorTxt02"><div class="errorTxt02">
                          </div>
                        </td>
                        <td>
                          <div class="input-field col s12 ">
